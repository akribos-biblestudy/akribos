...
Am 22.09.2026 wurde **Version 2 / Variante B „Akribos Studienblatt“** für den produktiven PDF-Export ausgewählt und zur Umsetzung und zum Deployment freigegeben. Die Entscheidung ist auch [in Issue #294 dokumentiert](https://github.com/akribos-biblestudy/akribos/issues/294#issuecomment-5776479111).

Maßgeblich sind die linksbündige Akribos-Text-Leseschrift, grüne Überschriften, helle Zitatflächen, echte Fett-/Kursivschnitte und Fußnoten am Ende der jeweiligen Seite. Die folgenden Dateien bewahren die ursprünglichen Vergleichsentwürfe; sie dienen als Gestaltungsreferenz für die Umsetzung.

## Ursprüngliche Vergleichsentwürfe
...
Die Proben validierten zunächst die gestalterische Machbarkeit mit Typst. Die anschließende produktive Umsetzung einschließlich Markdown-Adapter, Betriebsgrenzen und Exporttests ist in [PDF-Export](../../pdf-export.md) dokumentiert. Aus `Tagged: yes` folgt keine geprüfte PDF/UA-Konformität. Hebräisch und griechische Akzente wurden in den Proben visuell betrachtet; eine umfassende sprachwissenschaftliche Prüfung ist damit nicht verbunden.
