	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				html: `<h3>Word</h3><p>Text, Überschriften, Listen und Links werden übernommen. Seitenlayout, Bilder, Anlagen und Kommentare aus Word werden ausgelassen. Der Import überträgt den lesbaren Text in den Akribos-Editor; ein druckfertiges Word-Seitenlayout wird dabei nicht nachgebaut.</p><h3>Markdown und Obsidian</h3><ul><li>Überschriften der Ebenen 1 bis 6 bleiben als Überschriften erhalten.</li><li>Tabellenlayout, besondere Startwerte nummerierter Listen und Linktitel bleiben nicht erhalten.</li><li>Aufgaben-Kontrollkästchen werden zu gewöhnlichem lesbarem Text.</li><li>Bilder, Anlagen und Einbettungen werden entfernt oder auf eine lesbare Beschriftung reduziert.</li><li>Obsidian-Wikilinks werden, soweit unterstützt, zu normalen internen Links. Prüfe ihre Ziele nach dem Import.</li><li>Rohes HTML außer unterstütztem Unterstreichen und Hervorheben sowie zusätzliche Attribute werden entfernt.</li><li>Zeilenenden und nachgestellte Leerzeichen werden vereinheitlicht.</li></ul><p>Ein Dateiverweis auf eine andere Anwendung erhält durch den Import nicht automatisch einen passenden Zielbeitrag in Akribos. Verknüpfe zusammengehörige Dokumente nach der Übernahme bei Bedarf über <a href="/help/dokumente/bibeltexte-verknuepfungen#erwaehnungen">@-Erwähnungen</a>.</p>`
			},
			{
				id: 'metadaten',
