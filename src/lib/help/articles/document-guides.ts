...
export const documentGuides: HelpArticle[] = [
	...
	},
	{
		...
		sections: [
			...
			{
				id: 'tabellen',
				title: 'Tabellen einfügen und bearbeiten',
				html: `<ol><li>Setze den Cursor an die gewünschte Stelle und wähle <strong>Tabelle einfügen</strong> oder den Befehl <code>/tabelle</code>.</li><li>Fülle die drei Spalten aus. Die erste Zeile ist die Kopfzeile; darunter beginnen zwei Datenzeilen.</li><li>Wenn der Cursor in einer Zelle steht, kannst du über <strong>Zeile</strong> und <strong>Spalte</strong> weitere Zeilen oder Spalten einfügen und entfernen. <strong>Spalte ausrichten</strong> gilt für alle Zellen dieser Spalte.</li></ol><p><kbd>Tab</kbd> springt zur nächsten Zelle; am Tabellenende entsteht dabei eine weitere Zeile. <kbd>Shift</kbd> + <kbd>Tab</kbd> führt zurück. <kbd>Enter</kbd> erzeugt einen Zeilenumbruch innerhalb der Zelle. Fett, Kursiv, Links und Fußnoten bleiben möglich; leere Zellen bleiben erhalten.</p><p>Die Tabelle bleibt beim Wechsel zu Markdown, beim Speichern und in Word/PDF erhalten. Auf dem Smartphone kannst du eine breite Tabelle seitlich verschieben, ohne die ganze Seite zu verschieben. Zusammengeführte Zellen, verschachtelte Tabellen und feste Spaltenbreiten werden nicht unterstützt.</p><p>Bereits importierte Markdown-Notizen zeigen ihre Tabellen nach der technischen Aktualisierung ebenfalls, sofern die gespeicherte Markdown-Fassung noch echte Tabellenzeilen enthält. Wurde nur noch flacher Text mit Punkten zwischen den Wörtern gespeichert, wird daraus keine Tabelle geraten.</p>`
			},
			{
				id: 'fussnoten',
