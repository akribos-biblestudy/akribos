...
export const workspaceArticle: HelpArticle = {
	...
	sections: [
		...
		},
		{
			...
			<dl class="definition-list"><div><dt>Werke und Anordnung</dt><dd>Offene Tabs, aktive Tabs, Kachellayout und Trennergrößen.</dd></div><div><dt>Lesestellen</dt><dd>Die Stelle jedes Tabs, auch nach dem Scrollen, und seine Zuordnung zu einer Tabgruppe.</dd></div><div><dt>Studienansicht</dt><dd>Offene Suchen, Lexikon-Einträge und zugehöriger Wortstudien-Kontext.</dd></div><div><dt>Notizfilter</dt><dd>Die aktuelle Such- und Filterauswahl im Notizbereich.</dd></div></dl>
			<p>Mit deinem Konto kannst du den benannten Arbeitsbereich auch auf einem anderen Gerät öffnen. Welcher Arbeitsbereich gerade aktiv ist, merkt sich jeder Browser-Tab getrennt: Auf dem Smartphone kann „Stille Zeit“ geöffnet bleiben, während du am Computer „Research“ verwendest. Namen und gespeicherte Inhalte bleiben in deinem Konto gemeinsam verfügbar. Ein neuer Browser-Tab übernimmt die zuletzt gewählte Ansicht. Bereits offene Tabs bleiben an ihrer eigenen Stelle, auch wenn derselbe Arbeitsbereich auf einem anderen Gerät geändert wird. Klicke im Menü erneut auf den aktiven Arbeitsbereich, um den aktuellen gespeicherten Stand zu laden. Die persönliche Vor-/Zurück-Historie eines Tabs gehört zur laufenden Reader-Sitzung.</p>
		...
		},
		{
			...
			<h3>Einen Arbeitsbereich löschen</h3><ol><li>Öffne in diesem Browser-Tab zuerst einen anderen Arbeitsbereich. Der hier aktive Eintrag kann nicht gelöscht werden.</li><li>Wähle das Stiftsymbol neben dem nicht mehr benötigten Eintrag.</li><li>Wähle <strong>Löschen …</strong> und bestätige den angezeigten Namen mit <strong>Löschen</strong>.</li></ol><p>Du entfernst damit die gespeicherte Ansicht aus deinem Konto, auch für deine anderen Geräte. Hat ein anderes Gerät diesen Arbeitsbereich noch geöffnet, erhält es beim nächsten Zugriff eine vorhandene Ersatzansicht. Deine Notizen, Ausarbeitungen und Stellensammlungen bleiben in deinem Konto erhalten.</p>`,
			screenshot: {
		...
		},
		{
			...
			<details><summary>Warum ist „Löschen …“ nicht verfügbar?</summary><p>Der betreffende Arbeitsbereich ist auf diesem Gerät noch aktiv. Öffne hier zuerst einen anderen Eintrag und bearbeite danach den zu löschenden Arbeitsbereich.</p></details>
			<details><summary>Warum erscheint beim Speichern ein Konflikt?</summary><p>Wenn derselbe Arbeitsbereich auf mehreren Geräten oder in mehreren Browser-Tabs verändert wird, kann dein sichtbarer Stand inzwischen älter sein. Akribos überschreibt dann die neuere gespeicherte Ansicht nicht. Sichere gegebenenfalls ungespeicherte Dokumenteingaben und öffne den gewünschten Arbeitsbereich erneut über seinen Namen im Menü. Ein Wechsel auf einem anderen Gerät ändert deine aktive Auswahl nicht.</p></details>
