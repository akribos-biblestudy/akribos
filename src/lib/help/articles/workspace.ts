...
export const workspaceArticle: HelpArticle = {
	...
	sections: [
		...
		},
		{
			...
			<p>Mit deinem Konto kannst du den benannten Arbeitsbereich auch auf einem anderen Gerät öffnen. Welcher Arbeitsbereich gerade aktiv ist, merkt sich jeder Browser getrennt: Auf dem Smartphone kann „Stille Zeit“ geöffnet bleiben, während du am Computer „Research“ verwendest. Namen und gespeicherte Inhalte bleiben in deinem Konto gemeinsam verfügbar. Die persönliche Vor-/Zurück-Historie eines Tabs gehört zur laufenden Reader-Sitzung.</p>
